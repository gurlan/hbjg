...
<div class="container">
    ...
    <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=92def66e63cac5aa5cfeb99e63af97f6&action=position&posid=19&order=listorder+ASC&num=5\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">修改</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'position')) {$data = $content_tag->position(array('posid'=>'19','order'=>'listorder ASC','limit'=>'5',));}?>
    ...
    <div class="midads1 inner">
        ...
        <div class="midads1_search right">
            <form id="form" action="<?php echo APP_PATH;?>index.php?m=search&c=index&a=init&typeid=0&siteid=1&q=" method="get" onsubmit="return false">
                <input type="text" class="txt left" name="q" value="党的群众路线教育实践活动">
                <input  type=""  id="search" class="btn right">
            </form>
            <script>
    ...
    <div class="colcon1 inner">
        ...
        <div class="pannel02 right">
            ...
            <div class="videotit"><a href="<?php echo $r['url'];?>"><?php echo $r['title'];?></a></div>
            <?php $n++;}unset($n); ?>
        </div>
                ...
                <div class="pannel01 right">
                    <div class="colconL_tit">
                        <ul class="channel4" id="tab6">
                            ...
                            <li><a href="javascript:void(0);"><?php echo $CATEGORYS['212']['catname'];?></a></li>
                            <li><a href="javascript:void(0);"><?php echo $CATEGORYS['213']['catname'];?></a></li>
                        </ul>
                        <ul class="pub_more" id="tab6_more">
                            <li><a href="<?php echo $CATEGORYS['174']['url'];?>">更多</a></li>
                            <li style="display:none;"><a href="<?php echo $CATEGORYS['212']['url'];?>">更多</a></li>
                            <li style="display:none;"><a href="<?php echo $CATEGORYS['213']['url'];?>">更多</a></li>
                        </ul>
                    </div>
                    <div class="block_six">
                        <ul class="listcon listcon_zc">
                    ...
                    <div class="block_six" style="display:none;">
                        <ul class="listcon listcon_zc">
                            <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=4cd9d47002feccbeb87b8abb975402a2&action=lists&catid=212&num=8&order=listorder+ASC%2Cinputtime+desc&page=%24page\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">修改</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$pagesize = 8;$page = intval($page) ? intval($page) : 1;if($page<=0){$page=1;}$offset = ($page - 1) * $pagesize;$content_total = $content_tag->count(array('catid'=>'212','order'=>'listorder ASC,inputtime desc','limit'=>$offset.",".$pagesize,'action'=>'lists',));$pages = pages($content_total, $page, $pagesize, $urlrule);$data = $content_tag->lists(array('catid'=>'212','order'=>'listorder ASC,inputtime desc','limit'=>$offset.",".$pagesize,'action'=>'lists',));}?>
                            <?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
                            <li><a href="<?php echo $r['url'];?>" title="<?php echo $r['title'];?>"><?php echo $r['title'];?></a></li>
                            <?php $n++;}unset($n); ?>
                        </ul>
                    ...
                    <div class="block_six" style="display:none;">
                        <ul class="listcon listcon_zc">
                            <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=fb22ddf0d3547602cd74ef12ce69378d&action=lists&catid=213&num=8&order=listorder+ASC%2Cinputtime+desc&page=%24page\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">修改</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$pagesize = 8;$page = intval($page) ? intval($page) : 1;if($page<=0){$page=1;}$offset = ($page - 1) * $pagesize;$content_total = $content_tag->count(array('catid'=>'213','order'=>'listorder ASC,inputtime desc','limit'=>$offset.",".$pagesize,'action'=>'lists',));$pages = pages($content_total, $page, $pagesize, $urlrule);$data = $content_tag->lists(array('catid'=>'213','order'=>'listorder ASC,inputtime desc','limit'=>$offset.",".$pagesize,'action'=>'lists',));}?>
                            <?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
                            <li><a href="<?php echo $r['url'];?>" title="<?php echo $r['title'];?>"><?php echo $r['title'];?></a></li>
                            <?php $n++;}unset($n); ?>
                        </ul>
                ...
                <div class="pannel01 left">
                    <div class="colconL_tit">
                        <ul class="channel4" id="tab7">
                            <li><a href="javascript:void(0);" class="now"><?php echo $CATEGORYS['214']['catname'];?></a></li>
                            <li><a href="javascript:void(0);"><?php echo $CATEGORYS['178']['catname'];?></a></li>
                        </ul>
                        <ul class="pub_more" id="tab7_more">
                            <li><a href="<?php echo $CATEGORYS['214']['url'];?>">更多</a></li>
                            <li style="display:none;"><a href="<?php echo $CATEGORYS['178']['url'];?>">更多</a></li>
                        </ul>
                    </div>
                    <div class="block_seven lt_bg">
                        <ul class="listcon listcon_zc">
                            <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=9039fd4ed087773377a53c0f3cb5ec5d&action=lists&catid=214&num=8&order=listorder+ASC%2Cinputtime+desc&page=%24page\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">修改</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$pagesize = 8;$page = intval($page) ? intval($page) : 1;if($page<=0){$page=1;}$offset = ($page - 1) * $pagesize;$content_total = $content_tag->count(array('catid'=>'214','order'=>'listorder ASC,inputtime desc','limit'=>$offset.",".$pagesize,'action'=>'lists',));$pages = pages($content_total, $page, $pagesize, $urlrule);$data = $content_tag->lists(array('catid'=>'214','order'=>'listorder ASC,inputtime desc','limit'=>$offset.",".$pagesize,'action'=>'lists',));}?>
                            <?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
                            <li><a href="<?php echo $r['url'];?>" title="<?php echo $r['title'];?>"><?php echo $r['title'];?></a></li>
                            <?php $n++;}unset($n); ?>
                        </ul>
...
<div id="v_box" class="v_box">
    ...
    <div id="video" class="overlay-video-v2-plug">
        ...
        <iframe height=440 width=630 src='<?php echo $video;?>' frameborder=0 'allowfullscreen'></iframe>
