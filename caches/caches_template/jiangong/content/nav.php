<?php defined('IN_PHPCMS') or exit('No permission resources.'); ?><div class="menu left">
    ...
    <ul class="menu_list">
        ...
        <li><a href="<?php echo $r['url'];?>" <?php if($r[catid]==$parentid) { ?> class="now"<?php } ?>><?php echo $r['catname'];?></a></li>
        <?php $n++;}unset($n); ?>
